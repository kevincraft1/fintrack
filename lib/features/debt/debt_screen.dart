  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Catatan Hutang Piutang',
            style: TextStyle(
                color: AppColors.textPrimary,
                fontSize: 18.sp,
                fontWeight: FontWeight.bold)),
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    'Modul ini murni berfungsi sebagai buku catatan pengingat dan tidak akan memotong atau menambah saldo dompet Anda.',
                    style: TextStyle(
                        color: AppColors.textPrimary,
                        fontSize: 12.sp,
                        height: 1.5),
            ...
            child: Obx(() {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final color =
                      isDebt ? AppColors.error : const Color(0xFF10B981);
                  final icon =
                      isDebt ? Icons.arrow_upward : Icons.arrow_downward;
                  final typeLabel =
                      isDebt ? 'Saya Berhutang' : 'Memberi Pinjaman';
                    ...
                    child: Column(
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            Text(
                              formatCurrency.format(debt.totalAmount),
                              style: TextStyle(
                                  color: AppColors.textPrimary,
                                  fontSize: 18.sp,
                                  fontWeight: FontWeight.bold),
